...
class Product
{
     ...
     * Set autobidder
     *
     * @param \AppBundle\Entity\User $autobidder
     *
     * @return Product
     */
    public function setAutobidder(\AppBundle\Entity\User $autobidder = null)
    {
     ...
     * @return \AppBundle\Entity\User
     */
    public function getAutobidder()
    {
        return $this->autobidder;
    }
