...
@section('content')
    ...
    @foreach($fixtures as $fixture)
        ...
        <a href="/fixtures/{{$fixture->id}}"><table class="yann_fixture_table_maxsize">
            <tr class="yann_fixture_table_g">
                <table class=yann_fixture_subtable_maxsize>
                    <tr class="yann_fixture_table_g">
                        ...
                        <td class="yann_fixture_table_g">{{ $fixture->meteo }}</td>
                        <th class="yann_fixture_table_g">Refereed by</th>
                        <td class="yann_fixture_table_g">{{ $fixture->referee }}</td>
                    </tr>
                </table>
            </tr>
            <tr class="yann_fixture_table_g">
