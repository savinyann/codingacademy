$(document).ready(function()
{
    ...
    {
        $.get("server.php","behaviour=import_todo",function(data)
        {
            data.forEach(function(element)
            {
                $("ul").append("<li class='todo' id='todo_add_tag' tag='"+element["tag"]+"']>"+element["name"]+"<input type='text' name='tag_todo_add'><button>Add Tag</button></li>");
            })
        });
    });
    ...
    $("#getname").click(function()
    {
        ...
        {
            $("ul").append("<li class='todo' id='todo_add_tag' tag='']>"+data["name"]+"<input type='text' name='tag_todo_add'><button>Add Tag</button></li>");
        });
    });
